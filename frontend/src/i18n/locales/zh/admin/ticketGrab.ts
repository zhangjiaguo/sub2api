export default {
  ticketGrab: {
    ...
    forwardEgress: '转发出口单独圈定',
    forwardEgressHelp: '默认关闭 = 打票名单内全部账号的转发出站走打票代理（历史行为）；开启后仅被圈定账号的转发走打票代理，其余账号转发回落各自静态代理；打票探测始终走打票代理不受影响',
    forwardAccount: '转发出口',
    forwardAccountHelp: '圈定该账号的真实转发走打票动态代理；未圈定的打票账号转发回落各自静态代理',
