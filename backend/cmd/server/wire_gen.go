...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	openAITicketGrabService := service.ProvideOpenAITicketGrabService(openAITicketGrabRepository, accountRepository, openAITokenProvider, settingRepository)
	...
	openAIGatewayHandler := handler.ProvideOpenAIGatewayHandler(openAIGatewayService, pluginManager, tlsFingerprintProfileService, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, opsService, grokQuotaService, configConfig, coordinator)
