...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	pluginManager := service.ProvidePluginManager(pluginRepository, secretEncryptor, configConfig, pluginHostInfo, pluginKVStore, openAIGatewayService, settingRepository)
	...
	openAITicketGrabRepository := repository.NewOpenAITicketGrabRepository(db)
	openAITicketGrabService := service.ProvideOpenAITicketGrabService(openAITicketGrabRepository, accountRepository, openAITokenProvider, settingRepository, tlsFingerprintProfileService)
	openAITicketGrabHandler := admin.NewOpenAITicketGrabHandler(openAITicketGrabService)
	upstreamBillingProbeService := service.ProvideUpstreamBillingProbeService(accountRepository, accountTestService, settingService, leaderLockCache, db)
	openCodeGoUsageService := service.ProvideOpenCodeGoUsageService(accountRepository, httpUpstream, settingService, leaderLockCache, db)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, cnProviderHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, pluginHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, complianceHandler, auditLogHandler, openAITicketGrabHandler, upstreamBillingProbeService, ollamaCloudUsageService, openCodeGoUsageService)
