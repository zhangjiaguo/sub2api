...
func (s *AccountUsageService) probeOpenAICodexSnapshot(ctx context.Context, account *Account) (map[string]any, error) {
	...
	// 人设：探针与真实转发共用同一账号人设（codexAccountOverrideUserAgent），
	// 上游视角下"测试请求"与"业务请求"来自同一台机器。
	enforceCodexIdentityHeadersWithUA(req.Header, codexAccountOverrideUserAgent(account))
